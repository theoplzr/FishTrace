...
export const PLANS = [
  {
    ...
    features:[
      { text:'Lecture QR MaréeForce',         ok:true  },
      { text:'Nom du produit',                ok:true  },
      { text:'Provenance',                    ok:true  },
      { text:'Nom du pêcheur',                ok:true  },
      { text:'Traçabilité complète',          ok:false },
      { text:'Historique personnel',          ok:false },
      { text:'Avis et newsletter',            ok:false },
      { text:'Alternatives recommandées',     ok:false },
    ],
  ...
  },
  {
    ...
    features:[
      { text:'Traçabilité complète',          ok:true },
      { text:'Description produit/importation', ok:true },
      { text:'Historique personnel',          ok:true },
      { text:'Avis produit ou pêcheur',       ok:true },
      { text:'Goodies MaréeForce',            ok:true },
      { text:'Alternatives recommandées',     ok:true },
      { text:'Newsletter',                    ok:true },
